...
import { Calendar, Clock, Users, Ticket, CheckCircle2, User, Phone } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h1 className="text-4xl md:text-5xl font-extrabold text-gray-900 dark:text-white mb-6">
            Playground <span className="text-transparent bg-clip-text bg-gradient-to-r from-accent-400 to-accent-600">Happy Kids</span>
          </h1>
          <p className="text-xl text-gray-600 dark:text-gray-400">
            Fasilitas bermain anak indoor yang aman, nyaman, dan edukatif. Dilengkapi dengan wahana ketangkasan, area mandi bola, dan berbagai mainan interaktif.
          </p>
        </div>
          ...
          <div className="space-y-8">
            <div className="bg-white dark:bg-slate-800 rounded-3xl p-8 shadow-sm border border-gray-100 dark:border-slate-700">
              ...
              <div className="flex items-end gap-2 mb-2">
                <span className="text-4xl font-black text-brand-600 dark:text-brand-400">Rp 25.000</span>
                <span className="text-gray-500 dark:text-gray-400 mb-1">/ anak (sepuasnya)</span>
              </div>
              <p className="text-sm text-gray-500">*Satu tiket sudah termasuk gratis 1 pendamping dewasa.</p>
            </div>
            ...
            <div className="bg-gradient-to-br from-brand-600 to-brand-800 rounded-3xl p-8 text-white shadow-xl">
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  ...
                  <span>Anak & pendamping wajib memakai kaos kaki selama di area bermain.</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-6 h-6 text-brand-300 flex-shrink-0" />
                  <span>Dilarang membawa makanan ringan/minuman ke dalam zona karpet.</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-6 h-6 text-brand-300 flex-shrink-0" />
                  <span>Jaga kebersihan dan alat permainan, untuk keceriaan bersama.</span>
                </li>
              </ul>
            </div>
          </div>
          ...
          >
            {isBooked ? (
              <div className="text-center py-16">
                ...
                <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">Pemesanan Selesai</h3>
                <p className="text-gray-600 dark:text-gray-400 mb-8 max-w-sm mx-auto">
                  Tiket Playground untuk jadwal {time} atas nama {customerName} telah berhasil dicatat. 
                </p>
                <div className="flex flex-col gap-3">
                  <button 
                    onClick={() => {
                        setIsBooked(false);
                        setDate(""); setTime(""); setCustomerName(""); setCustomerPhone("");
                    }}
              ...
              <form onSubmit={handleBooking}>
                <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">Pesan Tiket Sekarang</h3>
                
                <div className="space-y-5">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2 flex items-center gap-2">
                        <User className="w-4 h-4 text-brand-500" /> Nama Ayah/Bunda
                      </label>
                      <input 
                        type="text" 
                        required
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2 flex items-center gap-2">
                      <Calendar className="w-4 h-4 text-brand-500" /> Tanggal Kunjungan
                    </label>
                    <input 
                      type="date" 
                      required
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2 flex items-center gap-2">
                        <Clock className="w-4 h-4 text-brand-500" /> Jam Kedatangan
                      </label>
                      <select 
                        required
                        value={time}
