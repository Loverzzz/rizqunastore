...
import { ArrowRight, ShoppingBag, Gamepad2, Sparkles, Clock } from "lucide-react";
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-xl text-gray-600 dark:text-gray-300 mb-8 max-w-2xl leading-relaxed">
                Rizquna menghadirkan toko serba ada terlengkap dan Playground Happy Kids yang interaktif. Temukan alat tulis, sembako, jajanan, hingga arena bermain anak dalam satu destinasi!
              </p>
              
              <div className="flex flex-col sm:flex-row gap-4">
                <Link href="/products" className="inline-flex justify-center items-center gap-2 px-8 py-4 rounded-full bg-brand-600 hover:bg-brand-700 text-white font-medium transition-all shadow-lg hover:shadow-brand-500/30">
                  <ShoppingBag className="w-5 h-5" />
                  Mulai Belanja
                </Link>
                <Link href="/playground" className="inline-flex justify-center items-center gap-2 px-8 py-4 rounded-full bg-white dark:bg-slate-800 text-gray-900 dark:text-white border border-gray-200 dark:border-slate-700 hover:border-accent-500 dark:hover:border-accent-500 font-medium transition-all shadow-sm hover:shadow-md">
      ...
      <section className="py-20 bg-gray-50 dark:bg-slate-900/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-4">Layanan Utama Kami</h2>
            <p className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">Kami menyediakan dua layanan utama untuk memenuhi kebutuhan belanja Anda dan hiburan untuk si buah hati.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">Rizquna Store</h3>
                <p className="text-gray-600 dark:text-gray-400 mb-6">
                  Toko perlengkapan alat tulis terlengkap, sembako segar, dan aneka jajanan favorit keluarga. Semua yang Anda cari ada di sini.
                </p>
                <Link href="/products" className="inline-flex items-center text-brand-600 dark:text-brand-400 font-semibold hover:text-brand-700 group-hover:gap-2 transition-all">
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">Playground Happy Kids</h3>
                <p className="text-gray-600 dark:text-gray-400 mb-6">
                  Area bermain luas yang aman dan edukatif. Dilengkapi berbagai wahana menyenangkan untuk melatih motorik anak.
                </p>
                <Link href="/playground" className="inline-flex items-center text-accent-600 dark:text-accent-400 font-semibold hover:text-accent-700 group-hover:gap-2 transition-all">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="relative z-10 text-center">
              <h2 className="text-3xl md:text-4xl font-bold mb-8">Jam Operasional Kami</h2>
              
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-6">
                  <h3 className="text-xl font-semibold mb-2">Senin - Jumat</h3>
                  <div className="text-3xl font-bold text-accent-300">09:00 - 21:00</div>
                </div>
                <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-6">
                  <h3 className="text-xl font-semibold mb-2">Sabtu - Minggu</h3>
                  <div className="text-3xl font-bold text-accent-300">08:00 - 21:00</div>
                </div>
              </div>
